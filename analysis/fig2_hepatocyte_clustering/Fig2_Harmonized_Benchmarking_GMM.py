...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        ...
        path = "X:/Benchmarking/feliciano/data_a_filtered_7.csv"
        ...
        process_modality(
            "X:/Benchmarking/aerts/hepatocyte_trajectory_export_with_celltype_ALLGROUPS_distances_v2.csv",
        ...
        process_modality(
            "X:/Benchmarking/mann/Matrix_Normalized_390x162.csv",
